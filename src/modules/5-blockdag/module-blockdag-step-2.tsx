...
export const ModuleBlockDagStep2: FC<ModuleBlockDagStep1Props> = ({}) => {
  ...
  return (
    <BasicFlow
      options={{
        layout: { ranksep: 140, nodesep: seps.node, edgesep: seps.edgesep },
      }}
      initialEdges={freshlyMinedExampleEdges}
      initialNodes={freshlyMinedExampleNodes}
    />
  );
};
